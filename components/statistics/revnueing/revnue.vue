  ...
  export default {
    ...
    methods: {
      getData() { //获取数据方法
        ...
        this.$axios.post("/queryshouru.action", params).then(function (result) {
          ...
          var option = {
            ...
            legend: {
              orient: 'vertical',
              left: 'left',
              data: ['佣金总发放量', '公司总营收', '年度总发放佣金', '年度总收入']
            },
            series: [
              {
                name: '营销收入',
      ...
      getDataqianwu() { //获取数据方法
        ...
        var params = new URLSearchParams();
        params.append("year", this.year);
        this.$axios.post("/queryqinwu.action", params).then(function (result) {
